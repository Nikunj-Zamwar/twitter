...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "95tBW7iMlmuf7OG1pF3jj5HLD", consumerSecret: "GOwDocC48jYPuWypCNzYpX4aDlOTGAJI4VV2Fn1VwVsymLhZ25")
    var loginSuccess: (() -> ())?
